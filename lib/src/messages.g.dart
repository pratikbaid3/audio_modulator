...
class ExampleHostApi {
  ...
  Future<void> playAudio(String path, double pitch, int speed) async {
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[path, pitch, speed]) as List<Object?>?;
  ...
  Future<void> stopAudio() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.audio_modulator.ExampleHostApi.stopAudio$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
